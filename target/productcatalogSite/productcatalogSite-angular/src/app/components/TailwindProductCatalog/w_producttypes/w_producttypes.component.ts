...
@Component({
   selector : "app-w-producttypes",
   templateUrl : "w_producttypes.component.html",
   styleUrls : ["w_producttypes.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["tailwindproductcatalogw_producttypes"])
export class WProducttypesComponent extends BaseControlComponent implements OnInit {
