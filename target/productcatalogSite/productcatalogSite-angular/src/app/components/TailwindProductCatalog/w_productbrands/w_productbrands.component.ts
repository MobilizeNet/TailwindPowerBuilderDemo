...
@Component({
   selector : "app-w-productbrands",
   templateUrl : "w_productbrands.component.html",
   styleUrls : ["w_productbrands.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["tailwindproductcatalogw_productbrands"])
export class WProductbrandsComponent extends BaseControlComponent implements OnInit {
