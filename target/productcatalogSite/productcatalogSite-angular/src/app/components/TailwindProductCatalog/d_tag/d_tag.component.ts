...
@Component({
   selector : "app-d_tag",
   templateUrl : "d_tag.component.html",
   styleUrls : ["d_tag.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["tailwindproductcatalogd_tag"])
export class DTagComponent extends BaseControlComponent implements OnInit {
