...
#line hidden
        ...
        protected override System.Collections.Generic.IEnumerable<string> _Mobilize_GetChanges()
        {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_dw_productbrands) > 0)
            {
                yield return "dw_productbrands";
            }
        ...
        protected override bool _Mobilize_HasChanges(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case "dw_productbrands":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_dw_productbrands) > 0;
            }
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["dw_productbrands"] = _Mobilize_References[3];
            return refs;
        }
        ...
        protected override System.Collections.Generic.IEnumerable<Mobilize.WebMap.Common.Core.IObservable> _Mobilize_GetReferences()
        {
            ...
            var ref_dw_productbrands = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.dw_productbrands);
            if (ref_dw_productbrands != null)
                yield return ref_dw_productbrands;
            yield break;
        }
        ...
        const uint _Mobilize_Dirty_dw_productbrands = (uint)1 << 3;
        const uint _Mobilize_Loaded_dw_productbrands = (uint)1 << 3;
#line 7
    }
}