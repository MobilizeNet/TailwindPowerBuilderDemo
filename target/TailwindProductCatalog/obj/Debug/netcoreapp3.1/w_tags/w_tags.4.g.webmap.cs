...
#line hidden
        ...
        protected override System.Collections.Generic.IEnumerable<string> _Mobilize_GetChanges()
        {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_dw_tag) > 0)
            {
                yield return "dw_tag";
            }
        ...
        protected override bool _Mobilize_HasChanges(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case "dw_tag":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_dw_tag) > 0;
            }
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["cb_update"] = _Mobilize_References[0];
            refs["cb_prev"] = _Mobilize_References[1];
            refs["cb_next"] = _Mobilize_References[2];
            refs["dw_tag"] = _Mobilize_References[3];
            return refs;
        }
        ...
        protected override System.Collections.Generic.IEnumerable<Mobilize.WebMap.Common.Core.IObservable> _Mobilize_GetReferences()
        {
            ...
            var ref_dw_tag = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.dw_tag);
            if (ref_dw_tag != null)
                yield return ref_dw_tag;
            yield break;
        }

        private uint _Mobilize_DirtyFlag_0;
        private uint _Mobilize_LoadedFlag_0;
        const uint _Mobilize_Dirty_cb_update = (uint)1 << 0;
        const uint _Mobilize_Loaded_cb_update = (uint)1 << 0;
        const uint _Mobilize_Dirty_cb_prev = (uint)1 << 1;
        const uint _Mobilize_Loaded_cb_prev = (uint)1 << 1;
        const uint _Mobilize_Dirty_cb_next = (uint)1 << 2;
        const uint _Mobilize_Loaded_cb_next = (uint)1 << 2;
        const uint _Mobilize_Dirty_dw_tag = (uint)1 << 3;
        const uint _Mobilize_Loaded_dw_tag = (uint)1 << 3;
#line 7
    }
}