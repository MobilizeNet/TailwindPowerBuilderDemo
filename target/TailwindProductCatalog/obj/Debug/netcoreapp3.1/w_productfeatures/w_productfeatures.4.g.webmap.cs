...
#line hidden
        ...
        protected override System.Collections.Generic.IEnumerable<string> _Mobilize_GetChanges()
        {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_dw_productfeatures) > 0)
            {
                yield return "dw_productfeatures";
            }
        ...
        protected override bool _Mobilize_HasChanges(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case "dw_productfeatures":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_dw_productfeatures) > 0;
            }
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["dw_productfeatures"] = _Mobilize_References[3];
            return refs;
        }
        ...
        protected override System.Collections.Generic.IEnumerable<Mobilize.WebMap.Common.Core.IObservable> _Mobilize_GetReferences()
        {
            ...
            var ref_dw_productfeatures = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.dw_productfeatures);
            if (ref_dw_productfeatures != null)
                yield return ref_dw_productfeatures;
            yield break;
        }
        ...
        const uint _Mobilize_Dirty_dw_productfeatures = (uint)1 << 3;
        const uint _Mobilize_Loaded_dw_productfeatures = (uint)1 << 3;
#line 7
    }
}