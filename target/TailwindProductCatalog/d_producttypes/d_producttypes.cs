namespace tailwindproductcatalog
{
      ...
      : Mobilize.Web.DataManager, Mobilize.Web.IDataManager
   {
      ...
      : base()
      {
         ...
         this.code_t.Band = Mobilize.Web.CaseExtensions.String("detail");
         this.code_t.Alignment = 1;
         this.code_t.Text = "Code:";
         this.code_t.Border = 0;
         this.code_t.Color = "33554432";
         this.code_t.X = 37;
         this.code_t.Y = 276;
         this.code_t.Height = 68;
         this.code_t.Width = 174;
         this.code_t.Name = Mobilize.Web.CaseExtensions.String("code_t");
         this.code_t.Visible = true;
         this.code_t.Font.FontFace = "Segoe UI";
         ...
         this.code.Font.FontFace = "Segoe UI";
         ...
         this.AddControls(new Mobilize.Web.DmControl[] { this.id_t, this._id, this.name_t, this._name, this.code_t, this.code });
